...
const File = (props) => {
  ...
  const handleOnSubmit = async (event) => {
    ...
    try {
      const { orderStatus, receivedDate, price1, daysSinceRequest, price2, requestDay, submission, vendor1, vendor2, category, catalog1, catalog2, date, description,notes, msdFile} = state;
